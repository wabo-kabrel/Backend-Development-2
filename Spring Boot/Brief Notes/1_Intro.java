...
// Old way (Spring Framework): You get an engine, tires, steering, bolts — and a manual.
// You assemble it all.

// Spring Boot way: You get a fully assembled car that runs. If you want to
//  swap the tires or add a spoiler, you can — but you don’t start from scratch.
 

// Real-world use cases
// - REST APIs for mobile apps (banking, e-commerce, booking systems).
// - Microservices that talk to each other.
// - Web applications with HTML templates.
// - Data processing systems that run scheduled tasks.
// - IoT backend systems for smart devices.
